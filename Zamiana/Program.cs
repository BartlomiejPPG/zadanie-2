...
namespace tak
{
    class Program
    {
        static void Main()
        {
            string filePath = @"C:\\Users\\Praktyka\\Desktop\\praktyki3P2\\Zamiana\praca.txt";
            try
            {
                ...
                Console.WriteLine("Zmiany zostały zapisane w pliku: " + changedFilePath + " o adresie: C:\\\\Users\\\\Praktyka\\\\Desktop\\\\praktyki3P2\\\\Zamiana"); //adres
            }
